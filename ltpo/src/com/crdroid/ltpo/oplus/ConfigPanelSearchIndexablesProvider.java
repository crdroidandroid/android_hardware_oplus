...
public class ConfigPanelSearchIndexablesProvider extends SearchIndexablesProvider {
    ...
    private static SearchIndexableResource[] INDEXABLE_RES = new SearchIndexableResource[]{
            new SearchIndexableResource(1, R.xml.ltpo_settings,
                    LTPOSettingsActivity.class.getName(),
    ...
    private static Object[] generateResourceRef(SearchIndexableResource sir) {
        ...
        ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = "com.crdroid.ltpo.oplus";
